...
def borough(recycle_hash)
  return recycle_hash["borough"]
end
...
def all_data(recycle_hash)
  recycle_hash.each_value do |value|
#    puts "#{value}"
  end
end
...
def key_and_data(recycle_hash)
  recycle_hash.each do |key, value|
